...
KindEditor.plugin('filemanager', function(K) {
	var self = this, name = 'filemanager',
		fileManagerJson = K.undef(self.fileManagerJson, self.basePath + 'handler/file_manager_json.ashx'),
...
KindEditor.plugin('flash', function(K) {
	var self = this, name = 'flash', lang = self.lang(name + '.'),
		...
		uploadJson = K.undef(self.uploadJson, self.basePath + 'handler/upload_json.ashx');
	self.plugin.flash = {
		edit : function() {
			var html = [
